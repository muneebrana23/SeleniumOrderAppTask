...
public class ReadCredsProperty {
	...
	public static Properties getPropertyObject() throws IOException {
		...
		FileInputStream fp = new FileInputStream("src/PropertiesFiles/orderApp_Creds_Properties ");
	...
	public static Properties getSelectorsObject() throws IOException {
		...
		FileInputStream fp = new FileInputStream("src/PropertiesFiles/orderApp_Selectors_Properties");
		Properties prop = new Properties();
		prop.load(fp);
		return prop;
	}
